...
class FrequencyAnalyzer : public juce::Thread
{
public:
	FrequencyAnalyzer() : juce::Thread("Frequency-Analyzer")
	{
		averager.clear();
	}
	~FrequencyAnalyzer() override = default;
	...
	void setUpFrequencyAnalyzer(int audioFifoSize, Type sampleRateToUse)
	{
